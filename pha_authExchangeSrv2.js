...
mongoose.connect('mongodb://mongodb:27017/auth_users', { useNewUrlParser: true, useUnifiedTopology: true }).then(() => {
	var dbUrl = 'mongoose.connection.mongodb://mongodb:27017/auth_users';
	...
	http.createServer(app).listen(30011);
});
