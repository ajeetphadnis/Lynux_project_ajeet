...
function createP12ECDSA_CLIENT_DOMAIN_TRUST_Cert(clientData, cacert, algType, req, res, next) {
    try	{
        ...
        //var type = args[0];
        // type='secp128r2';
		// E:\App2\App2\nwds75SP16\workspace\utes_proj\com.utes.cert.crypto_new\rsa_sub_sub_root
...
//        console.log(publicKey);
     ...
     // cert.validity.notAfter.setFullYear(cert.validity.notBefore.getFullYear());
	    ...
	    var subsubPem = fs.readFileSync(
		    //'E:/App2/App2/workspaces/PhadnisWorkspace/com.utes.cert.crypto/rsa_sub_sub_root/RSA_DOMAIN_SUB_SUB_CACert.pem', 'utf8');
			'E:/App2/App2/nwds75SP16/workspace/utes_proj/com.utes.cert.crypto_new/rsa_sub_sub_root/RSA_DOMAIN_SUB_SUB_CACert.pem', 'utf8');
...
//		    authorityInfoAccessIssuers: 'http://cacerts.digicert.com/DigiCertSHA2ExtendedValidationServerCA.crt'
	    ...
	    pkey = fs.readFileSync(
		    'E:/App2/App2/nwds75SP16/workspace/utes_proj/com.utes.cert.crypto_new/rsa_sub_sub_root/RSA_DOMAIN_SUB_SUB_CACert.pem',
		    'binary');
	    ...
	    sign.update(JSON.stringify(cert));  // data from your file would go here
	    var sig = sign.sign(key, 'hex');
	    console.log('Certificate Client_DOMAIN created:    '  + JSON.stringify(sign));
	    // get sub_ca cert and sub_sub_ca cert in pem format
	     var subsubCA =
	     fs.readFileSync('E:/App2/App2/nwds75SP16/workspace/utes_proj/com.utes.cert.crypto_new/rsa_sub_sub_root/RSA_DOMAIN_SUB_SUB_CACert.pem',
	     'utf8');
	    var subCA = fs.readFileSync(
		    'E:/App2/App2/nwds75SP16/workspace/utes_proj/com.utes.cert.crypto_new/rsa_sub_root/RSA_SUB_CA_DOMAINCert.pem', 'utf8');
