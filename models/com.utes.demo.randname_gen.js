...
function generateDemoUser (num) {
	if (num === 1) {
		...
		randuser.nameIdentifier = name;
		var lname = generateName2();
		randuser.fullname = name+lname;
		randuser.emailAddress = name+lname+'@hotmail.com';
		randuser.password = name;
		randuser.orgName = name+'.com';
		randuser.commonName = name+'.com';
		randuser.groups = "admin";
		randuser.mobilePhone = '9887452315';
		//console.log("Rand User:   " +  JSON.stringify(randuser));		
	}
	return randuser;
}

exports.generateDemoUser = generateDemoUser;
 //console.log( JSON.stringify(generateDemoUser (1)) );